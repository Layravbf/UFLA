...
static float solidZ2 = MAXZ2;
static float transparentZ = MINZ;
static GLuint sphereList, cubeList, coneList;
...
void display(void)
{
    ...
    GLfloat mat_red[] = { 1.0, 0.0, 0.2, 0.6 };

    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);

    glPushMatrix();
    glTranslatef(0.20, -0.15, solidZ2);
...
void keyboard(unsigned char key, int x, int y)
{
    ...
    case 'a':
    case 'A':
        //if (solidZ > transparentZ || solidZ2 > transparentZ) 
        solidZ = MAXZ;
        transparentZ = MINZ;
        solidZ2 = MAXZ2;
    ...
    case 'r':
    case 'R':
        if (solidZ2 > solidZ || transparentZ > solidZ) solidZ = transparentZ + 1.0;
        //solidZ = MAXZ + 0.5;
        //transparentZ = MINZ;
        //solidZ2 = MAXZ2 - 0.5;
        glutPostRedisplay();
    ...
    case 'C':
        //solidZ2 = MAXZ2 + 0.2;   
        if (solidZ > solidZ2 || transparentZ > solidZ2) {
            solidZ2 = transparentZ + 1.2;
            solidZ = MAXZ;
        }
        glutPostRedisplay();
        break;
