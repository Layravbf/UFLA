...
int main(int argc, char** argv)
{
	...
	//printf("Enter P1(x,y):\n");
	//std::cin >> p1.x;				// if you don't know what value should be given: enter 200
	//std::cin >> p1.y;
	...
	//std::cin >> p2.x;				// if you don't know what value should be given: enter 200
	//std::cin >> p2.y;
	...
	p[3].x = p[0].x;					// Assign last to first for connected everything
	p[3].y = p[0].y;
